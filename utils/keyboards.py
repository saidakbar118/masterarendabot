...
def user_main_menu():
    ...
    builder.button(text=BTN_SUB_ACCOUNTS)
    builder.adjust(2)
    return builder.as_markup(resize_keyboard=True)
...
def sub_accounts_keyboard(sub_accounts: list):
    """List existing sub-accounts with delete buttons + Add button."""
    builder = InlineKeyboardBuilder()
    ...
    builder.button(text=BTN_ADD_SUB, callback_data="sub_add")
    builder.adjust(1)
    return builder.as_markup()
